    ...
    <main className="container mx-auto md:w-1/2 p-8">
      <div className="text-lg md:text-justify leading-relaxed text-gray-900 dark:text-white">
        ...
        <p>
          ...
          in AI Programming for Python course. In this program, I got to develop
          a dog image classifier application. I learned the fundamentals of
          training a machine-learning model, the mathematical concepts behind
          deep learning, and deploying a trained model in the real world to make
